...
WRITTEN FOR POSTGRESQL 14.2-R1
...
(
	...
	CONSTRAINT accounts_customers_accounts FOREIGN KEY (account_id) REFERENCES accounts (account_id),
	CONSTRAINT accounts_customers_customers FOREIGN KEY (customer_id) REFERENCES customers (customer_id)
);
